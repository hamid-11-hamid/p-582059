  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black flex flex-col">
        <Header />
        <main className="max-w-none flex gap-24 bg-black mx-auto px-24 py-[80px] max-md:max-w-[991px] max-md:flex-col max-md:gap-[60px] max-md:px-10 max-md:py-[60px] max-sm:max-w-screen-sm max-sm:px-5 max-sm:py-10">
